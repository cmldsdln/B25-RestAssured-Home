...
public class SpartanPojoGetRequestTest extends SpartanTestBase {
    ...
    public void test1(){
        ...
        // here we are not passing path, that means we are getting all from the spartan class
        //if i wanna get spesific one i need to pass in path
        // "content[5]> this one means index 5 element....
